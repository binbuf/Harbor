...
public class DockMagnificationCalculatorTests
{
    ...
    private const double IconPitch = 134.0;

    [Fact]
    public void IconDirectlyUnderCursor_GetsMaxScale()
    {
        var centers = new[] { 0.0, 134.0, 268.0, 402.0, 536.0 };
        var scales = DockMagnificationCalculator.ComputeScales(268.0, centers, MaxScale, EffectRadius, IconPitch);
    ...
    {
        var centers = new[] { 0.0, 134.0, 268.0, 402.0, 536.0, 670.0, 804.0, 938.0 };
        ...
        // Icons at 536 (4 slots away), 670, 804, 938 should be 1.0
    ...
    {
        var offset = DockMagnificationCalculator.ComputeVerticalOffset(1.0, 102.0);
    ...
    {
        var offset = DockMagnificationCalculator.ComputeVerticalOffset(1.5, 102.0);
